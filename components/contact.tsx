...
export default function Contact() {
  ...
  return (
    ...
    >
      ...
      >
        <input
          className="h-14 p-4 rounded-lg border border-black/10 dark:bg-white dark:bg-opacity-80 dark:focus:bg-opacity-100 transition-all dark:outline-none"
          type="email"
